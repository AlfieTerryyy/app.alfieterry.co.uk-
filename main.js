...
document.addEventListener('DOMContentLoaded', () => {
    applySavedTheme(); // Ensure the theme is applied on page load
    updateFooterYear();
...
// Adjust footer height dynamically based on content and viewport height
document.addEventListener('DOMContentLoaded', function() {
    function adjustFooter() {
        ...
        if (documentHeight < viewportHeight) {
            content.style.minHeight = `${viewportHeight - footer.offsetHeight}px`; // Corrected
        } else {
